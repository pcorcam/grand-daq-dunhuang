...
void CSDAQApp::sysInit() {
    ...
    if(m_daqMode == 2 || m_daqMode == 3) {
        ...
        // m_eventStore = new EventStore("GRAND", "TEST-TRIGGER-ChanY-RUN88-DU11_and_DU18", "", 0, m_fh); // Create a new file to save data.
        m_eventStore = new EventStore("GRAND", m_dataFileName, "", 0, m_fh);
    ...
    if(m_daqMode == 1 || m_daqMode == 3) {
        ...
        m_rawEventStore = new rawEventStore("GRAND", m_dataFileName, "", 0, m_fh2);
        // m_rawEventStore = new rawEventStore("GRAND", "TEST-RAW-10s-ChanXYZ_20dB_DU10_16_17_19_20_21_29_32_33_35_10Dus_test", "", 0, m_fh2);
