...
void ZMQServer::initialize() {
    // std::cout << "ZMQServer::initialize" << std::endl;
    ...
    Server::initialize();
    // std::cout << "ZMQServer::initialize end" << std::endl;
}

void ZMQServer::terminate() {
    // std::cout << "ZMQServer::terminate" << std::endl;
    Server::terminate();

    delete[] m_address;
    m_address = nullptr;
    m_addressSize = 0;
    // std::cout << "ZMQServer::terminate end" << std::endl;
}

size_t ZMQServer::read(char* p, size_t maxSz) {
    // std::cout << "ZMQServer::read" << std::endl;
    int more;
    ...
    // std::cout << "ZMQServer::read end" << std::endl;
    if(succ) {
        return recvSize;
    }
    else {
...
void ZMQServer::write(char* p, size_t sz) {
    // std::cout << "ZMQServer::write" << std::endl;
    ...
    // std::cout << "ZMQServer::write end" << std::endl;
}
