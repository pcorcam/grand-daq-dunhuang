...
#define M_RINGBUFSZ 15000000 // // One comment, for the top limit of the FPGA is 1500Hz, the buffer sz should larger than 1500*8720=13M
#define M_BAKRINGBUFSZ 15000000
#define M_DUTIMESTAMPSZ 100000 // HERE! (M_RINGBUFSZ/szofEachEvent)*20 should less than M_DUTIMESTAMPSZ.
